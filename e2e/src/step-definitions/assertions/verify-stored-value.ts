...
Then(
    ...
    async function(this: ScenarioWorld, elementKey: ElementKey, negate: Negate, globalVariableKey: GlobalVariableKey) {
        ...
        console.log(`the ${elementKey} should ${negate?'not':''} equal the text ${globalVariables[globalVariableKey]} stored in global variables.`)
...
Then(
    ...
    async function(this: ScenarioWorld, elementKey: ElementKey, negate: Negate, globalVariableKey: GlobalVariableKey) {
        ...
        console.log(`the ${elementKey} should ${negate?'not':''} contain the text ${globalVariables[globalVariableKey]} stored in global variables.`)
